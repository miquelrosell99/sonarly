...
export function Queue({ user, showHeader = true, className }: QueueProps) {
  ...
  if (queue.length === 0) {
    return (
      <div className={cn('flex h-full flex-col items-center justify-center gap-2 text-fg-secondary', className)}>
