...
// SONARLY(W1): ID3v2.4 text frames may contain several values separated by
// NUL; return the parts instead of joining them (upstream did
// strings.Join(strings.Split(txt, "\x00"), "") — values were concatenated
// and lost).
