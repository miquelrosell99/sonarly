...
- [ ] P9 — OpenSubsonic adapter full parity (43 endpoints) against the quirks checklist — budgeted as the largest phase, not an afterthought (P9a browsing+retrieval ✅ `166f376`: all 24 endpoints, 56/61 quirks done, ~144 package tests; **P9b starring/now-playing/playlists/bookmarks next** — remaining 6 quirks T1–T4, N1, P1)
