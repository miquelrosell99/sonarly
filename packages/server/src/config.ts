...
const configSchema = z.object({
  ...
  INGEST_INTERVAL_MINUTES: z.coerce.number().default(60),
...
export type WorkerConfig = Pick<Config, 'DATA_DIR' | 'LIBRARY_PATH' | 'INGEST_PATH' | 'ORGANIZE_PATTERN' | 'SCAN_INTERVAL_MINUTES' | 'ARTIST_IMAGE_INTERVAL_MINUTES' | 'INGEST_INTERVAL_MINUTES' | 'REVIEW_RETENTION_DAYS' | 'WATCHER_USE_POLLING' | 'PUID' | 'PGID'>;
