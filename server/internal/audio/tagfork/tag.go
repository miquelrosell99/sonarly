...
// Forked from github.com/dhowden/tag (v0.0.0-20240417053706-3d75831295e8, BSD
...
// 2-byte tmpo) per ../../../../.audits/s1-metadata-findings.md. SONARLY(W1)/SONARLY(W2)
