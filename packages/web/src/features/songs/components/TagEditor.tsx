...
export function TagEditor({
  ...
  const fields: { key: keyof TagForm; label: string; type?: string; autocomplete?: 'artist' | 'album' | 'genre' }[] = [
    { key: 'title', label: 'Title' },
    { key: 'artist', label: 'Artist', autocomplete: 'artist' },
    { key: 'album', label: 'Album', autocomplete: 'album' },
