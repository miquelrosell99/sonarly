...
function isAutocompleteField(field: string): field is 'artist' | 'album' | 'albumArtist' | 'genre' | 'releaseType' {
  return field === 'artist' || field === 'album' || field === 'albumArtist' || field === 'genre' || field === 'releaseType';
}
