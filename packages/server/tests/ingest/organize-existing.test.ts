...
import { organizeExistingLibrary } from '../../src/ingest/organize-existing.js';
...
describe('organizeExistingLibrary', () => {
  ...
  beforeEach(() => {
    ...
    config = { PORT: 3000, DATA_DIR: '/data', LIBRARY_PATH: libraryPath, INGEST_PATH: '/data/ingest', ORGANIZE_PATTERN: '{artist}/{album}/{title}{ext}', SCAN_INTERVAL_MINUTES: 60, WATCHER_USE_POLLING: false, PUID: 1000, PGID: 1000, NODE_ENV: 'test', SESSION_SECRET: 'a'.repeat(32) };
  });
